...
public class GalleryData implements Parcelable {
    @NonNull private Date uploadDate=new Date(0);
    private int favoriteCount,id,pageCount,mediaId;
    @NonNull private String[] titles=new String[]{"","",""};
    @NonNull private TagList tags=new TagList();
    @NonNull private Page cover=new Page(),thumbnail=new Page();
    @NonNull private ArrayList<Page> pages=new ArrayList<>();
